// DOM Append Methods:
// 1.appendChildto : combine 2 things like tag & text (defination for my understanding.)
// 2.insertBefore
...
target.insertAdjacentText("afterend",newText);//("position"ke kaha pr esse dalnae,konsa element dalnae)
